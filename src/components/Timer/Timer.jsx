...
export default function Timer(){
    ...
    return (
      <div>
        {showTimer ? (
          <div className="flex items-center space-x-2 bg-gray py-1.5 px-4 font-normal cursor-pointer rounded hover:bg-light-gray text-background-color hover:text-gray">
          ...
          <div className="flex items-center p-1 h-8 hover:bg-dark-gray hover:text-background-color text-dark-gray rounded cursor-pointer" onClick={handleClockClick}>
            <svg
